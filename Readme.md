## A partir de l'ajout d'un jeton,
J'ai eu du mal ducoup je me suis permis de recopier votre correction pour que ça compile. Même si j'ai compris vos lignes de code, c'est du copié coller. Donc je pense qu'il faudrait en tenir compte dans la note.
